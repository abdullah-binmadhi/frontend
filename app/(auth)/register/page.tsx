            ...
            <Card className="border-border bg-card">
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input placeholder="Summoner name" className="bg-muted/50 text-sm" />
                    </div>
                    <div className="space-y-2">
                    ...
                    <Button className="w-full bg-gold text-navy hover:bg-gold/90 font-semibold">Create Account</Button>
