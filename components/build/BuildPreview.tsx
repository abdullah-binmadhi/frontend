...
export function BuildPreview({ build, index = 0 }: BuildPreviewProps) {
    ...
    return (
        ...
        >
            <Link href={`/builds/${build.id}`}>
                <Card className="overflow-hidden border-border bg-card transition-colors hover:border-gold/30 cursor-pointer">
